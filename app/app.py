...
from config import STYLES_CSS_FILE, tips
from server.feature_open import edit_function_logic, open_new_file_in_editor
from server.feature_save import save_results_logic
...
app_ui = ui.page_sidebar(
    ui.sidebar(
        ...
        ui.input_action_button("edit_function", "Edit function"),
...
def server(input, output, session):
    ...
    @reactive.effect
    @reactive.event(input.edit_function)
    def edit_function():
        edit_function_logic()
    ...
    def save_results():
        results_file_path = save_results_logic()
        open_new_file_in_editor(results_file_path)
